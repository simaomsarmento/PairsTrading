...
class SeriesAnalyser:
	...
	def find_cointegrated_pairs(self, data, threshold):
		"""
		...
		for i in range(n):
			for j in range(i+1, n):
				...
				result_aux = coint(S1, S2)
				result_aux2 = coint(S2, S1)
				pvalue_aux = result_aux[1]
				pvalue_aux2 = result_aux2[1]
				print('p value personalized1 : {} :: p value coint : {} :: p value coint2 {}'.format(pvalue,pvalue_aux, pvalue_aux2))
				if pvalue < threshold:
